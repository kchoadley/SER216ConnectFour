...
@Named("Scenario: Winner Detection - winning column present")
@SuppressWarnings("all")
public class GameFeatureWinnerDetectionWinningColumnPresent extends GameFeatureBackground {
  Player[] players = { this.player1, this.player2 };
  
  @Test
  @Order(0)
  @Named("Given a game with a winning column present")
  public void _givenAGameWithAWinningColumnPresent() {
    ...
    this.board.play(0, this.player1);
    this.board.play(0, this.player1);
    this.board.play(5, this.player2);
    this.board.play(4, this.player2);
    this.board.play(5, this.player2);
    this.board.play(4, this.player2);
  }
  ...
  @Test
  @Order(1)
  @Named("Then game should return player1 as winner")
  public void _thenGameShouldReturnPlayer1AsWinner() {
