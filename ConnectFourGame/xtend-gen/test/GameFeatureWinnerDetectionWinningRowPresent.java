...
@Named("Scenario: Winner Detection - winning row present")
@SuppressWarnings("all")
public class GameFeatureWinnerDetectionWinningRowPresent extends GameFeatureBackground {
  Player[] players = { this.player1, this.player2 };
  
  @Test
  @Order(0)
  @Named("Given a game with a winning row present")
  public void _givenAGameWithAWinningRowPresent() {
  ...
  @Test
  @Order(1)
  @Named("Then game should return player1 as winner again")
  public void _thenGameShouldReturnPlayer1AsWinnerAgain() {
